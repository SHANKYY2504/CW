...
const Heronew = () => {
  ...
  useEffect(() => {
    let topPosition = 0; // Start from the very left
    let bottomPosition = 0; // Start from the very left
      ...
      <div className="absolute inset-0 bg-black">
        ...
        <div 
          ...
          style={{
            ...
            maskImage: 'linear-gradient(to bottom, black, black)' // Removes gradient fade
          }}
        />
